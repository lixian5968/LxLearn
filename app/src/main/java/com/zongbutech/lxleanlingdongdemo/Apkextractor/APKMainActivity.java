package com.zongbutech.lxleanlingdongdemo.Apkextractor;
...
public class APKMainActivity extends ActionBarActivity {
			...
			.setPositiveButton(R.string.alert_root_yes, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					try {
						...
						Toast.makeText(APKMainActivity.this, String.format(APKMainActivity.this.getString(R.string.toast_extracted), dst), Toast.LENGTH_SHORT).show();
					} catch (Exception e) {
						e.printStackTrace();
						Toast.makeText(APKMainActivity.this, R.string.toast_failed, Toast.LENGTH_SHORT).show();
					}
				}
	...
	class Loader extends AsyncTask<Void, ApplicationInfo, Void> {
		...
		APKMainActivity mainActivity;

		public Loader(APKMainActivity a) {
