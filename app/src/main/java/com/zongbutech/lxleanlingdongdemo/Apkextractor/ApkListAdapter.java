...
public class ApkListAdapter extends RecyclerView.Adapter<ApkListAdapter.ViewHolder> {
	...
	public APKMainActivity mActivity;
	...
	public ApkListAdapter(APKMainActivity activity) {
	...
	public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
		return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.apk_list_item, viewGroup, false), this);
	}
